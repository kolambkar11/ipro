                ...
                <div className="p-8 sm:p-10 lg:flex-auto">
                  ...
                  >
                    <li className="flex gap-x-3">
                      ...
                      team with the knowledge and skills needed to identify and
                      mitigate cybersecurity threats, enhancing your
                ...
                <div className="p-8 sm:p-10 lg:flex-auto">
                  ...
                  >
                    <li className="flex gap-x-3">
                      ...
                      manage security threats without having to hire additional
                      staff.
                    </li>
                  </ul>
                </div>
                  ...
                  >
                    <li className="flex gap-x-3">
                      <BsCheckCircle
                        ...
                        aria-hidden="true"
                      />
                      Our training programs are tailored to your specific needs,
                      providing you with training that is relevant to your
                  ...
                  >
                    <li className="flex gap-x-3">
                      <BsCheckCircle
                        ...
                        aria-hidden="true"
                      />
                      Our experienced trainers are certified and have extensive
                      experience in the cybersecurity industry, ensuring that
                      you receive the highest quality training possible.
                    </li>
                    <li className="flex gap-x-3">
                      <BsCheckCircle
                        className="h-6 w-5 flex-none text-amber-700"
